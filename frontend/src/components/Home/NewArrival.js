         ...
         <div className='flex justify-between border-main border-b-[2px] pb-4'>
            ...
            <div className='flex'>
               <span
                  ...
                  className={`text-[14px] ${activeTab === 'smartphone' ? 'text-main' : 'text-[#8a8a8a]'
               ...
               <span
                  ...
                  className={`text-[14px] ${activeTab === 'tablet' ? 'text-main' : 'text-[#8a8a8a]'
               ...
               <span
                  ...
                  className={`text-[14px] ${activeTab === 'laptop' ? 'text-main' : 'text-[#8a8a8a]'
